...
# opts.Add(PathVariable("target_path", "The path where the lib will be installed.", "deps/libopenmpt"))
# opts.Add(PathVariable("godot_path", "Command/Path to a Godot 4.0.x executable", "godot", PathVariable.PathAccept))
...
# elif platform == "windows":
	...
	# env.Append(CCFLAGS=["-DWIN32", "-D_WIN32", "-D_WINDOWS", "-W3", "-std=c++17" "-GR", "-D_CRT_SECURE_NO_WARNINGS"])
	# if env["target"] in ("template_debug", "editor"):
